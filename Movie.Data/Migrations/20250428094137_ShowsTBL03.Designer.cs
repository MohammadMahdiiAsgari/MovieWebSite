...
namespace Movie.Data.Migrations
{
    ...
    [Migration("20250428094137_ShowsTBL03")]
    partial class ShowsTBL03
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.Episodes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EpisodeContentRating")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ImageNameForEpisode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.Seasons", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.ShowListTVShowsSubGroup", b =>
                {
                    b.Property<int>("ShowId")
                        .HasColumnType("int");

                    b.Property<int>("TVShowsSubGroupId")
                        .HasColumnType("int");

                    b.HasKey("ShowId", "TVShowsSubGroupId");

                    b.HasIndex("TVShowsSubGroupId");

                    b.ToTable("ShowListTVShowsSubGroups");
                });

            modelBuilder.Entity("Movie.Domain.Models.TVShows.ShowLists", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.TVShowsGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.TVShowsSubGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.Episodes", b =>
                {
                    b.HasOne("Movie.Domain.Models.TVShows.Seasons", "Season")
                        .WithMany("Episodes")
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.Seasons", b =>
                {
                    b.HasOne("Movie.Domain.Models.TVShows.ShowLists", "ShowLists")
                        .WithMany("Seasons")
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.ShowListTVShowsSubGroup", b =>
                {
                    b.HasOne("Movie.Domain.Models.TVShows.ShowLists", "ShowLists")
                        .WithMany("ShowListTVShowsSubGroups")
                        .HasForeignKey("ShowId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Movie.Domain.Models.TVShows.TVShowsSubGroup", "TVShowsSubGroup")
                        .WithMany("ShowListTVShowsSubGroups")
                        .HasForeignKey("TVShowsSubGroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ShowLists");

                    b.Navigation("TVShowsSubGroup");
                });

            modelBuilder.Entity("Movie.Domain.Models.TVShows.TVShowsSubGroup", b =>
                {
                    b.HasOne("Movie.Domain.Models.TVShows.TVShowsGroup", "TVShowsGroups")
            ...
            modelBuilder.Entity("Movie.Domain.Models.TVShows.ShowLists", b =>
                {
                    ...
                    b.Navigation("ShowListTVShowsSubGroups");
                });
